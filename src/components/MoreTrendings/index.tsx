...
function MoreTrending() {
  return (
    <section className="bg-primary">
      <div className="mx-auto max-w-[1312px] px-4 w-full min-h-[539px] flex items-center justify-center flex-col">
        <h2
          className={`${EffraFont.className} text-7xl font-semibold italic text-center`}
        >
